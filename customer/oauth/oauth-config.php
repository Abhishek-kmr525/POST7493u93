...
if (!defined('GOOGLE_CLIENT_ID')) {
    define('GOOGLE_CLIENT_ID', 
        (!empty($oauthSettings['google_client_id']))  // CHANGED: removed 'oauth_' from column name
            ? $oauthSettings['google_client_id'] 
...
if (!defined('GOOGLE_CLIENT_SECRET')) {
    define('GOOGLE_CLIENT_SECRET', 
        (!empty($oauthSettings['google_client_secret']))  // CHANGED: removed 'oauth_' from column name
            ? $oauthSettings['google_client_secret'] 
...
function getOAuthCredentialsSource() {
    ...
    // Check Google credentials (FIXED column names)
    if (!empty($oauthSettings['google_client_id'])) {  // CHANGED: removed 'oauth_'
